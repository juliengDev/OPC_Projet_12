...
const Keydata = ({ datas, type }) => {
  ...
  const displayCalorieCount = `${formattedCalorieCount}Kcal`
  const displayCalorieTxt = "Calories"
  const displayProteinCount = `${proteinCount}g`
  const displayProteinTxt = "Proteines"
  const displayCarbohydrateCount = `${carbohydrateCount}g`
  const displayCarbohydrateTxt = "Glucides"
  const displayLipidCount = `${lipidCount}g`
  const displayLipidTxt = "Lipides"

  return (
    <aside className="keyData">
      <div className="keyData__bloc">
        {type === "calories" && (
          <span className="keyData__bloc-icon-carb">
            <svg
              width="17"
              height="20"
              viewBox="0 0 17 20"
        ...
        {type === "proteines" && (
          <span className="keyData__bloc-icon-prot">
            <svg
              width="19"
              height="19"
              viewBox="0 0 19 19"
        ...
        {type === "glucides" && (
          <span className="keyData__bloc-icon-glucid">
            <svg
              width="18"
              height="20"
              viewBox="0 0 18 20"
        ...
        {type === "lipides" && (
          <span className="keyData__bloc-icon-lipid">
            <svg
              width="20"
              height="19"
              viewBox="0 0 20 19"
        ...
        {type === "calories" && (
          <div className="keyData__bloc-info">
            <h2 className="keyData__bloc-info-calorieCount">
              {displayCalorieCount}
            </h2>
            <p className="keyData__bloc-info-calorieTxt">{displayCalorieTxt}</p>
          </div>
        )}
        {type === "proteines" && (
          <div className="keyData__bloc-info">
            ...
            <p className="keyData__bloc-info-calorieTxt">{displayProteinTxt}</p>
          </div>
        )}
        {type === "glucides" && (
          <div className="keyData__bloc-info">
            <h2 className="keyData__bloc-info-calorieCount">
              {displayCarbohydrateCount}
            </h2>
            <p className="keyData__bloc-info-calorieTxt">
              {displayCarbohydrateTxt}
            </p>
          </div>
        )}
        {type === "lipides" && (
          <div className="keyData__bloc-info">
            ...
            <p className="keyData__bloc-info-calorieTxt">{displayLipidTxt}</p>
          </div>
        )}
      </div>
    </aside>
